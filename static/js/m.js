...
(function () {
  var ajax = function (options) {
    ...
    xmlHttp.open(type, v_options.site_url + url);
  ...
  var showMsg = null;
  avalon.component('ms-msg', {
    template: `<div class="vaptcha-tip-cont" :class='{none: @invisible}'>
        <div class="vaptcha-dz-tip vaptcha-tip-warn" :if="@type === 'error'">
            <img class="dz-tip-icon" src="http://discuz.top/source/plugin/phone_auth/static/img/vaptcha-dz-warning.png">
            <span class="dz-tip-text">{{@msg}}</span>
        </div>
        <div class="vaptcha-dz-tip vaptcha-tip-success" :if="@type === 'success'">
            <img class="dz-tip-icon" src="http://discuz.top/source/plugin/phone_auth/static/img/vaptcha-dz-success.png">
            <span class="dz-tip-text">{{@msg}}</span>
        </div>
    </div>`,
    defaults: {
  ...
  avalon.component('ms-vaptcha', {
    template: '<div class="vaptcha_container"><div class="vaptcha-init-main"><div class="vaptcha-init-loading"><a><img src="https://cdn.vaptcha.com/vaptcha-loading.gif"></a><span class="vaptcha-text"><a href="https://www.vaptcha.com/" title="CAPTCHA " target="_blank">CAPTCHA </a>is initialing...</span></div></div></div>',
    defaults: {
      data: {},
      isPass: false,
      onReady: function (e) {
        this.loadScript(this.initVaptcha);
      },
      initVaptcha: function () {
        var self = this;
        ajax({
          url: '/plugin.php?id=phone_auth&action=getChallenge&scene=01&t=' + (new Date()).getTime(),
  ...
  avalon.component('ms-login', {
    template: `<div class="content active" >
        <div class="dz-item-group">
            <label class="dz-intro">账号：</label>
            <input class="form-control dz-input" placeholder="用户名/手机号" type="text" :duplex="@form.user" :rules='{required: true}'>
        </div>
        <div class="dz-item-group">
            <label class="dz-intro">密码：</label>
            <input class="form-control dz-input" placeholder="密码" type="text" :duplex="@form.password">
        </div>
        <div class="dz-item-group">
            <label class="dz-intro">人机验证：</label>
            <xmp :widget="{is:'ms-vaptcha', $id: 'login-vaptcha'}"></xmp>            
        </div>
        <div class="dz-item-group">
          <label class="dz-intro"></label>
          <button class="btn dz-btn" :attr='{disabled: !@isValidated}' :click="@login">绑定</button>
        </div>
    </div>`,
    defaults: {
      form: {
      ...
      $computed: {
        isValidated: function () {
          return trim(this.form.user) && this.form.password.length > 5;
        }
      },
      onReady: function () {
        this.vaptcha = avalon.vmodels['login-vaptcha'];
      },
      login: function () {
        if (!this.vaptcha.isPass) {
          return showMsg('请进行人机验证');
        }
        this.form.vaptcha_token = this.vaptcha.data.token
        this.form.vaptcha_challenge = this.vaptcha.data.challenge
        var self = this;
        ajax({
          url: '/plugin.php?id=phone_auth&mod=logging&action=login&auth=qq&loginsubmit=yes',
          type: 'POST',
          data: this.form,
          success: function (data) {
  ...
  // avalon.component('ms-sendcode', {
  //   template
  // })

  avalon.component('ms-register', {
    template: `<div class="content active" :visible="@active == 'register'">
        <div class="dz-item-group">
            <label class="dz-intro"><sup>*</sup>用户名：</label>
            <input class="form-control dz-input" placeholder="用户名" type="text" >
            <span class="dz-title">用户名3-15个字符组成，不能纯数字</span>
        </div>
        <div class="v-line"></div>
        <div class="dz-item-group">
            <label class="dz-intro"><sup>*</sup>密码：</label>
            <input class="form-control dz-input" placeholder="密码" type="text" >
            <span class="dz-title">密码由6-20个字符组成</span>
            <div class="pw-strength pw-medium">
        ...
        <div class="v-line"></div>
        <div class="dz-item-group">
            <label class="dz-intro"><sup>*</sup>手机号：</label>
            <input class="form-control dz-input" placeholder="手机号" type="text" >
        ...
        <div class="dz-item-group">
            <label class="dz-intro"><sup>*</sup>人机验证：</label>
            <xmp :widget="{is:'ms-vaptcha', $id: 'register-vaptcha', cb: '1'}"></xmp>            
        </div>
        <div class="v-line"></div>
        <div class="dz-item-group">
            <label class="dz-intro"></label>
            ...
            <span class="dz-item-text">
                <span>同意</span>
                <a class="dz-link" href="javascript:;">网站服务条款</a>
            </span>
        </div>
        
        <div class="dz-item-group">
            <label class="dz-intro"></label>
            <button class="btn dz-btn" :attr='{disabled: !@isValidated}' :click="@register">注册</button>            
        </div>
    </div>`,
    defaults: {
      form: {
      ...
      onReady: function() {
        this.vaptcha = avalon.vmodels['register-vaptcha'];
      },
      $computed: {
        isValidated: function () {
          return trim(this.form.username) 
