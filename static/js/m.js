  ...
  avalon.component('ms-login', {
    template: `<div class="content active">
        <div class="dz-item-group">
            ...
            <input class="form-control dz-input" type="text" :duplex="@form.user">
            <span class="dz-title"><a href="" class="dz-link">立即注册</a></span>
        </div>
        <div class="dz-item-group">
            <label class="dz-intro">密码：</label>
            <input class="form-control dz-input" type="text" :duplex="@form.password">
            <span class="dz-title"><a href="" class="dz-link">找回密码</a></span>
        </div>
        <div class="dz-item-group">
            <label class="dz-intro">人机验证：</label>
            <xmp :widget="{is:'ms-vaptcha'}"></xmp>
        </div>
        <div class="dz-item-group">
        ...
        <div class="dz-item-group">
            <label class="dz-intro"></label>
            <button class="btn dz-btn" :click="@login">绑定</button>
        </div>
    </div>`,
    defaults: {
      form: {
